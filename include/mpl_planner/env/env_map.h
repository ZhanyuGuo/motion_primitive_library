...
namespace MPL
{
  ...
  public:
     ...
     * @param action_idx The array stores corresponding idx of control input for each successor
     *
                  ...
                  std::vector<int> &action_idx) const
    {
      ...
      for (unsigned int i = 0; i < this->U_.size(); i++)
      {
        ...
        if (tn == curr || !validate_primitive(pr, this->v_max_, this->a_max_, this->j_max_, this->yaw_max_))
          continue;
